...
public final class SQLCommand {
	...
	//BOOK
		public static final String INSERT_BOOK = "INSERT INTO book (title, brief, publish_year, author) VALUE (?,?,?,?)";
		public static final String SELECT_BOOK_WHERE_ID = "SELECT * FROM book WHERE book_id = ?";
	...
	//EMPLOYEE
		public static final String INSERT_EMPLOYEE = "INSERT INTO employee (name, date_of_birth, email) VALUE (?,?,?)";
		public static final String SELECT_EMPLOYEE_WHERE_ID = "SELECT * FROM employee WHERE employee_id = ?";
